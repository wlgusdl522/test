...
// 팀명도 키에 함께 둔다(조회 편의). 발표포함: 원래 구글슬라이드로 발표할 때도 등록된 사업구분을
// 전부 보여주지 않고 2~3개만 골라 보여줬다고 해서, 보기 화면에서 그렇게 골라 보는 용도로 추가.
export const STAFF_MEETING_VALUE_HEADERS = [
  '사업구분ID', '팀명', '년월', '업무보고', '업무계획', '협조사항', '작성자이메일', '작성자명', '등록일시', '발표포함',
];
