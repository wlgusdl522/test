            ...
            <tbody>
              {filtered.length === 0 ? (
                ...
                <tr key={r.id}>
                  ...
                  <td className={td} style={{ textAlign: 'right' }}>{r.출발계기판 ? Number(r.출발계기판).toLocaleString() : ''}</td>
                  <td className={td} style={{ textAlign: 'right' }}>{r.도착계기판 ? Number(r.도착계기판).toLocaleString() : ''}</td>
