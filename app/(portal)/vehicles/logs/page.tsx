...
export default async function VehicleLogsPage({
  ...
  return (
    <>
      ...
      <form action={editing ? updateVehicleLogAction : addVehicleLogAction} className={`${card} grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3`}>
        ...
        <div className="sm:col-span-2 lg:col-span-2 rounded-md border border-dashed border-zinc-300 dark:border-zinc-700 p-3">
